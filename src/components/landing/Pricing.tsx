  ...
  return (
    <section id="pricing" className="py-20 bg-gray-50">
      <div className="container mx-auto px-6">
        <Card className="max-w-2xl mx-auto bg-green-600 text-white shadow-2xl">
          <CardHeader className="text-center">
            <CardTitle className="text-3xl md:text-4xl font-bold">
              👉 Beta Offer - Limited to 5 Agencies Only
            </CardTitle>
            <CardDescription className="text-green-200 text-lg pt-2">
          ...
          <CardContent className="text-center">
            <div className="my-8">
              ...
              <p className="text-green-200">(installation + customization)</p>
              <p className="text-4xl font-bold my-4">+</p>
              <p className="text-xl">
                <span className="text-5xl font-bold">$500</span>/month
              </p>
              <p className="text-green-200">(monitoring, updates, and optimization)</p>
            </div>
